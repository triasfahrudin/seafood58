...
--
--  Dump database pos_seafood58 on 16-08-2010 1:41:08 PM
--
...
--
--  Table data for table "data_login". Record count - 2 
--
...
--
--  Table data for table "data_modal". Record count - 6 
--
...
CREATE TABLE `data_pendapatan` (
  ...
  `tgl_edit` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 COMMENT='0->pake_meja,1->penjualan_langsung,2->lain2 ';

--
--  Table data for table "data_pendapatan". Record count - 5 
--
...
--
--  Table data for table "data_pengeluaran". Record count - 10 
--
...
--
--  Table data for table "detail_pendapatan". Record count - 6 
--
...
INSERT INTO temp_report_stok VALUES (2,'KEPITING',65,10,0,0,'ons',1);
