...
# Dumping structure for table db_test.bilangan
...
# Dumping data for table db_test.bilangan: ~12 rows (approximately)
...
# Dumping data for table db_test.data_app_menu: 56 rows
...
INSERT INTO `data_app_menu` (`id`, `parent`, `nama`, `tgl_edit`) VALUES
	...
	(461, 450, 'SPTPD', NULL),
	(462, 450, 'SSPD', NULL),
	(443, 440, 'REKAP PENJUALAN', NULL),
	(463, 450, 'REKAP PENJUALAN', NULL),
	(432, 400, 'PERUBAHAN STOK', NULL),
	(433, 400, 'TUTUP BUKU HARIAN', NULL),
	(458, 450, 'DESIGN PERUBAHAN STOK', NULL),
	(459, 450, 'DESIGN TUTUP BUKU HARIAN', NULL),
	(460, 450, 'DESIGN MODAL', NULL),
	(434, 400, 'MODAL', NULL),
...
INSERT INTO `data_login` (`id`, `id_pegawai`, `login`, `logout`, `keterangan`, `tgl_edit`) VALUES
	(1, 5, '2011-08-03 14:23:38', '2011-08-03 14:28:04', NULL, NULL);
...
# Dumping data for table db_test.data_modal: 0 rows
...
INSERT INTO `data_modal` (`id`, `tgl`, `besar`, `id_pegawai`, `keterangan`, `tgl_edit`, `is_daritutupbuku`, `id_tutupbuku`) VALUES
	(1, '2011-08-03', 10000000, 5, NULL, NULL, NULL, NULL);
...
# Dumping data for table db_test.data_pegawai: 4 rows
...
INSERT INTO `data_pegawai` (`id`, `nama`, `alamat`, `notlp`, `password`, `IsOperator`, `IsActive`, `privilege`, `isSinuhun`, `tgl_edit`) VALUES
	(1, 'sodik', NULL, NULL, '1468', 1, 1, ';100;101;102;103;104;105;106;107;200;300;301;302;303;304;305;306;307;400;450;451;452;453;454;455;500;501;502;503;504;505;506', 1, NULL),
	...
	(5, 'trias', NULL, NULL, 'trias', 1, 1, ';100;101;102;103;104;105;106;107;200;300;301;302;303;304;305;306;307;308;400;410;411;412;420;421;422;430;431;432;433;434;440;441;442;443;450;451;452;453;454;455;456;457;458;459;460;461;462;463;500;501;502;503;504;505;506;507', 1, NULL);
...
CREATE TABLE IF NOT EXISTS `data_pendapatan` (
  ...
  `tgl_edit` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='0->pake_meja,1->penjualan_langsung,2->lain2 ';

# Dumping data for table db_test.data_pendapatan: 0 rows
...
INSERT INTO `data_pendapatan` (`id`, `typependapatan`, `id_meja`, `tgl`, `id_pegawai`, `keterangan`, `struk`, `discount`, `bayar`, `datetimeposted`, `tgl_edit`) VALUES
	(1, 0, 1, '2011-08-03', 5, NULL, '1/0-tri/03082011', 0, 50000, '2011-08-03 14:26:51', NULL);
...
# Dumping data for table db_test.data_pengeluaran: 0 rows
...
INSERT INTO `data_pengeluaran` (`id`, `item`, `id_satuan`, `banyak`, `harga_satuan`, `keterangan`, `tgl`, `id_pegawai`, `isBahanUtama`, `id_subjenismenu`, `tgl_edit`) VALUES
	(1, 'Pembelian: KEPITING', 1, 10, 100000, '', '2011-08-03', 5, 1, 2, NULL);
...
# Dumping data for table db_test.data_perubahan: 0 rows
...
# Dumping data for table db_test.data_perubahan_stok: ~0 rows (approximately)
...
# Dumping data for table db_test.detail_pendapatan: 0 rows
...
# Dumping data for table db_test.temp_bahanpembentuk: ~0 rows (approximately)
...
# Dumping data for table db_test.temp_report_stok: ~0 rows (approximately)
...
# Dumping structure for procedure db_test.terbilang
...
# Dumping structure for function db_test.terbilang
