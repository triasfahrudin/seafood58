...
const
  ...
  //_________Authorization__________
  HARGA_PADA_MAINFORM = 'HARGA_PADA_MAINFORM'; //edit + baru
  BANYAK_PADA_MAINFORM = 'BANYAK_PADA_MAINFORM'; //edit

  //________uFrmBahanPembentuk
  BAHANPEMBENTUK_DELETE = 'BAHANPEMBENTUK_DELETE';
  BAHANPEMBENTUK_EDIT = 'BAHANPEMBENTUK_EDIT';

  //________uFrmCatatanPembelianBahanUtama
  CATATAN_PEMBELIAN_BAHAN_UTAMA_DELETE = 'CATATAN_PEMBELIAN_BAHAN_UTAMA_DELETE';
  CATATAN_PEMBELIAN_BAHAN_UTAMA_EDIT = 'CATATAN_PEMBELIAN_BAHAN_UTAMA_EDIT';

  //_________uFrmCatatanPengeluaran_1
  CATATANPENGELUARAN_DELETE = 'CATATANPENGELUARAN_DELETE';
  CATATANPENGELUARAN_EDIT = 'CATATANPENGELUARAN_EDIT';

  //_________uFrmHistoryPendapatan
  HISTORYPENDAPATAN_DELETE = 'HISTORYPENDAPATAN_DELETE';
  HISTORYPENDAPATAN_EDIT = 'HISTORYPENDAPATAN_EDIT';

  //________uFrmListJenisMenu
  LISTJENISMENU_DELETE = 'LISTJENISMENU_DELETE';
  LISTJENISMENU_EDIT = 'LISTJENISMENU_EDIT';

  //________uFrmListJenisSatuan
  LISTJENISSATUAN_DELETE = 'LISTJENISSATUAN_DELETE';
  LISTJENISSATUAN_EDIT = 'LISTJENISSATUAN_EDIT';

  //________uFrmListSubJenisMenu
  LISTSUBJENISMENU_DELETE = 'LISTSUBJENISMENU_DELETE';
  LISTSUBJENISMENU_EDIT = 'LISTSUBJENISMENU_EDIT';

  //_______uFrmMasterBumbuDapur
  MASTERNONMENU_DELETE = 'MASTERNONMENU_DELETE';
  MASTERNONMENU_EDIT = 'MASTERNONMENU_EDIT';

  //_______uFrmMasterEmployee
  MASTEREMPLOYEES_DELETE = 'MASTEREMPLOYEES_DELETE';
  MASTEREMPLOYEES_EDIT = 'MASTEREMPLOYEES_EDIT';

  //_______uFrmMasterMeja
  MASTERMEJA_DELETE = 'MASTERMEJA_DELETE';
  MASTERMEJA_EDIT = 'MASTERMEJA_EDIT';

  //_______uFrmMasterMenu_2
  MASTERMENU_DELETE = 'MASTERMENU_DELETE';
  MASTERMENU_EDIT = 'MASTERMENU_EDIT';

  //_______uFrmMasterMenu_2_Barcode
  MASTERMENUBARCODE_DELETE = 'MASTERMENUBARCODE_DELETE';
  MASTERMENUBARCODE_EDIT = 'MASTERMENUBARCODE_EDIT';

  //______uFrmModalAwal
  MODALAWAL_DELETE = 'MODALAWAL_DELETE';
  MODALAWAL_EDIT = 'MODALAWAL_EDIT';

  //______uFrmPerubahanModal
  PERUBAHAN_STOK_DELETE = 'PERUBAHAN_STOK_DELETE';
  PERUBAHAN_STOK_EDIT = 'PERUBAHAN_STOK_EDIT';

  //______uFrmSatuanKonversi
  SATUAN_KONVERSI_DELETE = 'SATUAN_KONVERSI_DELETE';
  SATUAN_KONVERSI_EDIT = 'SATUAN_KONVERSI_EDIT';
...
function isAllowPriv(sPriv: string): string;
procedure InsertPriv(sPriv: string; isPermanent: string; pemberiIjin: string);
procedure DeletePriv(sPriv: string);
procedure DeleteAllPriv;
...
function isAllowPriv(sPriv: string): string;
begin
  //result YES , NO , PERMANENTLY
  DM.ExecSQL(
    'SELECT COUNT(*),isPermanent'#13 +
    'FROM temp_priv'#13 +
    'WHERE id_pegawai = %d AND strPriv = "%s"', [dm.iAPPid, sPriv],
    dm.mySQLQuery1);

  if (dm.mySQLQuery1.Fields[0].AsInteger = 0) or (DM.mySQLQuery1.RecordCount = 0)
    then
  begin
    Result := 'N';
  end
  ...
  begin
    if DM.mySQLQuery1.Fields[1].AsString = 'Y' then
      Result := 'PERMANENTLY'
    else
      Result := 'Y';
  end;
...
begin
  dm.ExecSQL(
    'INSERT INTO TEMP_PRIV(id_pegawai,strPriv,isPermanent,pemberi_ijin)'#13 +
    'VALUES (%d,"%s","%s","%s")',
    [dm.iAPPid, sPriv, isPermanent, pemberiIjin],
    DM.mySQLQuery1);
end;
...
begin
  dm.ExecSQL(
    ...
    'where id_pegawai = %d and strPriv = "%s" and isPermanent = "%s"',
    [dm.iAPPid, sPriv, 'N'], dm.mySQLQuery1);
end;

procedure DeleteAllPriv;
begin
  DM.ExecSQL('TRUNCATE temp_priv', [], DM.mySQLQuery1);
end;
